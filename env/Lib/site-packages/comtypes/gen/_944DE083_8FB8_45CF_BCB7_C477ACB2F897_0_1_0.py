...
__all__ = [
    ...
    'IUIAutomationExpandCollapsePattern', 'StyleId_Heading7',
    'TextUnit_Page',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'ExpandCollapseState_PartiallyExpanded', 'UIA_WindowPatternId',
    ...
    'UIA_StatusBarControlTypeId', 'AnnotationType_MoveChange',
    'IUIAutomationScrollItemPattern', 'StyleId_Heading4',
    'TreeTraversalOptions_Default',
    'IUIAutomationCustomNavigationPattern',
    'IUIAutomationTextPattern', 'UIA_Transform2ZoomMaximumPropertyId',
    'StructureChangeType_ChildrenInvalidated',
    'UIA_IsMultipleViewPatternAvailablePropertyId', 'HeadingLevel3',
    'IUIAutomation4', 'IUIAutomation6', 'UIA_SpinnerControlTypeId',
    'UIA_LegacyIAccessibleDescriptionPropertyId', 'UiaChangeInfo',
    'ZoomUnit_SmallDecrement', 'UIA_FrameworkIdPropertyId',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'ProviderOptions_RefuseNonClientSupport', 'UIA_LinkAttributeId',
    'UIA_TableColumnHeadersPropertyId', 'NavigateDirection',
    'UIA_LegacyIAccessibleSelectionPropertyId',
    'TextEditChangeType_CompositionFinalized',
    'UIA_StyleNameAttributeId',
    'UIA_ScrollVerticalViewSizePropertyId',
    'UIA_DataGridControlTypeId', 'NotificationProcessing',
    'UIA_AriaPropertiesPropertyId', 'UIA_StyleIdAttributeId',
    'ProviderOptions_ProviderOwnsSetFocus',
    'UIA_DocumentControlTypeId', 'UIA_SelectionSelectionPropertyId',
    'UIA_IsTextEditPatternAvailablePropertyId',
    'UIA_Drag_DragCancelEventId', 'UIA_NamePropertyId',
    'UIA_CapStyleAttributeId', 'UIA_SpreadsheetItemFormulaPropertyId',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'TreeScope_Children', 'TextEditChangeType_Composition',
    'UIA_IsGridItemPatternAvailablePropertyId',
    'UIA_AnimationStyleAttributeId', 'UIA_TabItemControlTypeId',
    'UIA_LabeledByPropertyId', 'UIA_Transform2ZoomMinimumPropertyId',
    'TextUnit', 'IUIAutomationProxyFactoryMapping',
    'RowOrColumnMajor', 'UIA_PositionInSetPropertyId',
    'UIA_DragPatternId', 'StructureChangeType_ChildrenBulkRemoved',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'OrientationType_None', 'UIA_DropTarget_DragLeaveEventId',
    'IUIAutomationElement9', 'UIA_AccessKeyPropertyId',
    'UIA_CaretPositionAttributeId', 'UIA_MenuOpenedEventId',
    'TextPatternRangeEndpoint_Start', 'UIA_WindowControlTypeId',
    'UIA_FontWeightAttributeId', 'UIA_TablePatternId',
    'UIA_ObjectModelPatternId', 'UIA_AcceleratorKeyPropertyId',
    'UIA_IsItalicAttributeId', 'Off',
    'UIA_IsSelectionPatternAvailablePropertyId', 'IUIAutomation',
    'IUIAutomationMultipleViewPattern', 'ToggleState_On',
    'AnnotationType_ExternalChange', 'TextUnit_Format',
    'UIA_SelectionActiveEndAttributeId',
    'UIA_VirtualizedItemPatternId',
    'UIA_GridItemContainingGridPropertyId',
    'AnnotationType_TrackChanges', 'UIA_UnderlineColorAttributeId',
    'UIA_MultipleViewPatternId', 'UIA_CenterPointPropertyId',
    'ProviderOptions_ServerSideProvider',
    'UIA_IsControlElementPropertyId', 'UIA_FlowsToPropertyId',
    'UIA_LayoutInvalidatedEventId', 'UIA_SummaryChangeId',
    'StyleId_Heading8', 'UIA_SelectionItemIsSelectedPropertyId',
    'AnnotationType_InsertionChange',
    'UIA_ForegroundColorAttributeId', 'UIA_TableItemPatternId',
    'UIA_CustomNavigationPatternId', 'TreeTraversalOptions_PostOrder',
    'NavigateDirection_NextSibling', 'UIA_SizeOfSetPropertyId',
    'IUIAutomationObjectModelPattern', 'UIA_EditControlTypeId',
    'UIA_TableRowHeadersPropertyId', 'UIA_FullDescriptionPropertyId',
    'TreeTraversalOptions_LastToFirstOrder',
    'UIA_IsPasswordPropertyId', 'ProviderOptions_ClientSideProvider',
    'TextUnit_Document', 'TreeScope_Element',
    'UIA_UnderlineStyleAttributeId', 'UIA_MenuItemControlTypeId',
    'UIA_StylesStyleIdPropertyId', 'TextEditChangeType',
    'UIA_AutomationPropertyChangedEventId', 'TreeTraversalOptions',
    'UIA_MenuModeEndEventId', 'IUIAutomationElement6',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'TreeScope_Parent', 'UIA_IsTextChildPatternAvailablePropertyId',
    'UIA_DragIsGrabbedPropertyId', 'UIA_SelectionPattern2Id',
    'UIA_IsDragPatternAvailablePropertyId', 'StyleId_BulletedList',
    'IRawElementProviderSimple', 'UIA_NativeWindowHandlePropertyId',
    'UIA_CultureAttributeId', 'UIA_IsContentElementPropertyId',
    'IUIAutomationElement4', 'UIA_WindowIsModalPropertyId',
    'UIA_SelectionItemPatternId', 'StyleId_Normal',
    'StyleId_Heading1', 'SupportedTextSelection_Single',
    'UIA_MenuClosedEventId', 'UIA_ProcessIdPropertyId',
    'TextUnit_Character', 'UIA_ExpandCollapsePatternId',
    'IUIAutomationGridPattern', 'UIA_TransformCanMovePropertyId',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'IUIAutomationSpreadsheetPattern',
    'UIA_InputReachedTargetEventId', 'UIA_LegacyIAccessiblePatternId',
    'HeadingLevel6', 'AnnotationType_Footnote', 'ExtendedProperty',
    'UIA_SplitButtonControlTypeId', 'StyleId_Heading2',
    'StyleId_Heading3', 'UIA_TabsAttributeId',
    'UIA_SearchLandmarkTypeId', 'UIA_AnnotationTypesPropertyId',
    'UIA_SelectionCanSelectMultiplePropertyId',
    'UIA_HasKeyboardFocusPropertyId', 'UIA_TitleBarControlTypeId',
    'UIA_GridRowCountPropertyId', 'WindowInteractionState_Closing',
    'UIA_RangeValuePatternId',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId',
    'UIA_TreeControlTypeId', 'AnnotationType_Footer',
    'AnnotationType_Sensitive', 'NavigateDirection_LastChild',
    'UIA_SpreadsheetPatternId', 'AnnotationType_FormatChange',
    'UIA_GridPatternId', 'UIA_IsDockPatternAvailablePropertyId',
    'UIA_Text_TextChangedEventId',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'PropertyConditionFlags', 'StructureChangeType_ChildAdded',
    'UIA_ToolBarControlTypeId', 'IUIAutomationTextRange3',
    'UIA_DockPatternId', 'IUIAutomationGridItemPattern',
    'IUIAutomationPropertyCondition', 'UIA_DragDropEffectPropertyId',
    'UIA_IsLegacyIAccessiblePatternAvailablePropertyId',
    'SupportedTextSelection_Multiple',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'IUIAutomationTextRangeArray',
    'UIA_HostedFragmentRootsInvalidatedEventId', 'HeadingLevel7',
    'UIA_TextEdit_ConversionTargetChangedEventId',
    'UIA_IsSuperscriptAttributeId',
    'WindowInteractionState_BlockedByModalWindow',
    'UIA_ScrollBarControlTypeId', 'TreeScope_None',
    'UIA_LocalizedControlTypePropertyId', 'UIA_FlowsFromPropertyId',
    'UIA_Drag_DragStartEventId', 'UIA_IsOffscreenPropertyId',
    'IUIAutomationTextEditTextChangedEventHandler',
    'UIA_Invoke_InvokedEventId',
    'IUIAutomationPropertyChangedEventHandler',
    'CoalesceEventsOptions_Enabled', 'UIA_SeparatorControlTypeId',
    'AnnotationType_Author', 'IUIAutomation5',
    'RowOrColumnMajor_ColumnMajor',
    'UIA_TransformCanRotatePropertyId', 'UIA_SystemAlertEventId',
    'IUIAutomationElement3',
    'UIA_Selection2LastSelectedItemPropertyId',
    'StructureChangeType_ChildrenBulkAdded',
    'UIA_WindowCanMaximizePropertyId', 'UIA_FontNameAttributeId',
    'UIA_ProviderDescriptionPropertyId',
    'AnnotationType_ConflictingChange', 'UIA_TransformPattern2Id',
    'IUIAutomationTextEditPattern', 'Assertive',
    'UIA_MarginTrailingAttributeId', 'WindowInteractionState',
    'UIA_ButtonControlTypeId', 'UIA_Selection_InvalidatedEventId',
    'TextEditChangeType_AutoCorrect', 'StyleId_NumberedList',
    'SynchronizedInputType_KeyUp',
    'IUIAutomationSpreadsheetItemPattern', 'StyleId_Heading6',
    'UIA_AnnotationTypesAttributeId', 'UIA_StylesShapePropertyId',
    'UIA_AsyncContentLoadedEventId', 'IUIAutomationElement7',
    'IUIAutomationAnnotationPattern',
    'UIA_DragGrabbedItemsPropertyId', 'UIA_RangeValueValuePropertyId',
    'UIA_LocalizedLandmarkTypePropertyId',
    'ProviderOptions_UseComThreading', 'UIA_ComboBoxControlTypeId',
    'UIA_OutlineThicknessPropertyId', 'UIA_StructureChangedEventId',
    'WindowVisualState_Normal',
    'UIA_DropTargetDropTargetEffectsPropertyId', 'ToggleState_Off',
    'UIA_SynchronizedInputPatternId', 'UIA_ControlTypePropertyId',
    'AutomationElementMode_None', 'SupportedTextSelection',
    'IUIAutomationElement', 'DockPosition_Fill',
    'UIA_ListControlTypeId', 'ProviderOptions_UseClientCoordinates',
    'IUIAutomation3', 'UIA_TableItemRowHeaderItemsPropertyId',
    'UIA_TransformPatternId', 'UIA_IndentationTrailingAttributeId',
    'ZoomUnit_LargeIncrement', 'AnnotationType_GrammarError',
    'UIA_LegacyIAccessibleHelpPropertyId',
    'UIA_IsSelectionPattern2AvailablePropertyId',
    'IUIAutomationElement5', 'StyleId_Subtitle',
    'UIA_TransformCanResizePropertyId',
    'UIA_AnnotationTargetPropertyId', 'NavigateDirection_FirstChild',
    'UIA_RangeValueMaximumPropertyId', 'UIA_PaneControlTypeId',
    'UIA_HorizontalTextAlignmentAttributeId',
    'UIA_IsPeripheralPropertyId', 'IUIAutomationTableItemPattern',
    'ConnectionRecoveryBehaviorOptions',
    'IUIAutomationSelectionPattern', 'UIA_ItemContainerPatternId',
    'CoalesceEventsOptions_Disabled', 'AnnotationType_SpellingError',
    'UIA_SayAsInterpretAsMetadataId',
    'UIA_Transform2CanZoomPropertyId',
    'UIA_GridItemRowSpanPropertyId', 'ExpandCollapseState',
    'IUIAutomationTextPattern2', 'DockPosition_Right',
    'UIA_StrikethroughColorAttributeId',
    'IUIAutomationTransformPattern', 'ScrollAmount_LargeIncrement',
    'UIA_InputReachedOtherElementEventId',
    'UIA_CheckBoxControlTypeId', 'UIA_MenuModeStartEventId',
    'UIA_IndentationFirstLineAttributeId',
    'UIA_StylesStyleNamePropertyId', 'WindowInteractionState_Running',
    'StyleId_Quote', 'UIA_OptimizeForVisualContentPropertyId',
    'AnnotationType_AdvancedProofingIssue', 'ToggleState',
    'TextUnit_Line', 'IUIAutomationDragPattern',
    'UIA_TreeItemControlTypeId', 'SynchronizedInputType_KeyDown',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'NotificationProcessing_ImportantAll',
    'UIA_CalendarControlTypeId', 'IUIAutomationTextRange',
    'DockPosition', 'UIA_IsInvokePatternAvailablePropertyId',
    'ZoomUnit', 'UIA_IsSpreadsheetItemPatternAvailablePropertyId',
    'UIA_DropTargetDropTargetEffectPropertyId',
    'UIA_HeadingLevelPropertyId', 'UIA_CulturePropertyId',
    'UIA_TextEditPatternId', 'TextUnit_Word', 'StyleId_Heading9',
    'AnnotationType_FormulaError', 'UIA_GridItemRowPropertyId',
    'HeadingLevel4', 'IUIAutomationValuePattern', 'UIA_TextPatternId',
    'UIA_HyperlinkControlTypeId', 'UIA_Window_WindowOpenedEventId',
    'ConnectionRecoveryBehaviorOptions_Enabled',
    'UIA_DescribedByPropertyId', 'UIA_MarginLeadingAttributeId',
    'UIA_StrikethroughStyleAttributeId',
    'UIA_IsRequiredForFormPropertyId', 'StyleId_Emphasis',
    ...
    'ScrollAmount_SmallDecrement', 'UIA_ClickablePointPropertyId',
    ...
    'UIA_HelpTextPropertyId', 'ToggleState_Indeterminate',
    'OrientationType_Vertical', 'IUIAutomationRangeValuePattern',
    'UIA_BulletStyleAttributeId', 'NotificationKind_Other',
    'WindowVisualState', 'IUIAutomationSelectionPattern2',
    'UIA_ChangesEventId', 'UIA_BeforeParagraphSpacingAttributeId',
    'IUIAutomationDropTargetPattern',
    'UIA_StylesFillPatternStylePropertyId', 'UIA_TableControlTypeId',
    'LiveSetting', 'UIA_StylesFillPatternColorPropertyId',
    'UIA_StylesFillColorPropertyId',
    'UIA_LegacyIAccessibleValuePropertyId', 'HeadingLevel2',
    ...
    'UIA_TogglePatternId', 'UIA_IsTextPattern2AvailablePropertyId',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'AnnotationType_Highlighted', 'UIA_ControllerForPropertyId',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId',
    'UIA_IsTransformPatternAvailablePropertyId',
    'UIA_DockDockPositionPropertyId', 'IUIAutomationElementArray',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'UIA_VisualEffectsPropertyId', 'UIA_ItemStatusPropertyId',
    'UIA_RangeValueIsReadOnlyPropertyId', 'UIA_MenuControlTypeId',
    'UIA_TextChildPatternId',
    'UIA_MultipleViewSupportedViewsPropertyId',
    'SynchronizedInputType_LeftMouseDown',
    'IUIAutomationItemContainerPattern', 'IUIAutomationAndCondition',
    'ProviderOptions', 'UIA_InvokePatternId',
    'UIA_LegacyIAccessibleChildIdPropertyId',
    'ExpandCollapseState_Expanded',
    'NotificationProcessing_MostRecent',
    'IUIAutomationTransformPattern2', 'UIA_ScrollPatternId',
    'UIA_TextControlTypeId', 'UIA_IsDataValidForFormPropertyId',
    'UIA_IsStylesPatternAvailablePropertyId', 'IUIAutomationElement2',
    'IUIAutomationEventHandlerGroup', 'UIA_LevelPropertyId',
    'DockPosition_Left', 'UIA_HeaderItemControlTypeId',
    'PropertyConditionFlags_IgnoreCase', 'TreeScope_Ancestors',
    'UIA_IsSubscriptAttributeId', 'IUIAutomationTogglePattern',
    'IUIAutomationScrollPattern', 'UIA_LiveSettingPropertyId',
    'UIA_SemanticZoomControlTypeId',
    'UIA_AnnotationDateTimePropertyId', 'IUIAutomationInvokePattern',
    'IUIAutomationActiveTextPositionChangedEventHandler',
    'TextUnit_Paragraph', 'AnnotationType_UnsyncedChange',
    'CoalesceEventsOptions', 'NotificationKind_ActionCompleted',
    'UIA_ScrollHorizontallyScrollablePropertyId',
    'UIA_IsTablePatternAvailablePropertyId', 'TreeScope',
    'UIA_ScrollItemPatternId',
    'UIA_StylesExtendedPropertiesPropertyId', 'OrientationType',
    'UIA_LegacyIAccessibleNamePropertyId',
    'UIA_Selection2ItemCountPropertyId',
    'UIA_IsItemContainerPatternAvailablePropertyId',
    'AnnotationType_Unknown', 'UIA_DropTarget_DroppedEventId',
    'UIA_InputDiscardedEventId',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'AnnotationType_Comment',
    'UIA_IsSpreadsheetPatternAvailablePropertyId',
    'UIA_AnnotationObjectsAttributeId', 'HeadingLevel1',
    'UIA_ImageControlTypeId', 'SynchronizedInputType_RightMouseUp',
    ...
    'UIA_DataItemControlTypeId', 'UIA_FontSizeAttributeId',
    'TextEditChangeType_AutoComplete', 'AnnotationType_Header',
    'HeadingLevel5', 'UIA_AnnotationAuthorPropertyId',
    'IUIAutomationFocusChangedEventHandler',
    'UIA_SayAsInterpretAsAttributeId', 'UIA_CaretBidiModeAttributeId',
    'ZoomUnit_LargeDecrement', 'IUIAutomation2',
    'IUIAutomationOrCondition',
    'StructureChangeType_ChildrenReordered',
    'UIA_MarginTopAttributeId', 'UIA_TableRowOrColumnMajorPropertyId',
    'IUIAutomationCondition', 'UIA_NotificationEventId',
    'IUIAutomationDockPattern', 'UIA_SpreadsheetItemPatternId',
    'UIA_SelectionPatternId', 'IUIAutomationEventHandler',
    'UIA_ToolTipControlTypeId', 'IUIAutomationCacheRequest',
    'TreeScope_Descendants', 'NavigateDirection_PreviousSibling',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'WindowVisualState_Minimized', 'UIA_IsActiveAttributeId',
    'UIA_WindowCanMinimizePropertyId', 'UIA_Drag_DragCompleteEventId',
    'UIA_CustomControlTypeId', 'UIA_IsDialogPropertyId',
    'DockPosition_Bottom', 'UIA_ToolTipClosedEventId',
    'IUIAutomationTablePattern',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'UIA_SizePropertyId', 'StructureChangeType',
    'UIA_SliderControlTypeId', 'UIA_OutlineColorPropertyId',
    'UIA_DropTargetPatternId', 'RowOrColumnMajor_Indeterminate',
    'HeadingLevel9', 'UIA_RuntimeIdPropertyId',
    'UIA_RangeValueMinimumPropertyId', 'UIA_AutomationIdPropertyId',
    'IUIAutomationVirtualizedItemPattern',
    'UIA_RadioButtonControlTypeId', 'NotificationKind_ItemRemoved',
    'DockPosition_None', 'UIA_Text_TextSelectionChangedEventId',
    'UIA_IsReadOnlyAttributeId', 'AnnotationType_Mathematics',
    'UIA_LineSpacingAttributeId', 'UIA_DropTarget_DragEnterEventId',
    'AnnotationType_DeletionChange', 'NavigateDirection_Parent',
    'UIA_OutlineStylesAttributeId', 'UIA_FillColorPropertyId',
    'UIA_SelectionItem_ElementSelectedEventId',
    'UIA_DragDropEffectsPropertyId', 'HeadingLevel8',
    'IUIAutomationProxyFactory',
    'UIA_IsWindowPatternAvailablePropertyId',
    'UIA_TextEdit_TextChangedEventId',
    'IUIAutomationChangesEventHandler',
    'UIA_LiveRegionChangedEventId', 'Polite',
    'NotificationKind_ItemAdded',
    'AnnotationType_EditingLockedChange', 'UIA_ToolTipOpenedEventId',
    'IUIAutomationElement8', 'IUIAutomationProxyFactoryEntry',
    'UIA_AriaRolePropertyId', 'UIA_IsValuePatternAvailablePropertyId',
    'UIA_ProgressBarControlTypeId',
    'UIA_IsRangeValuePatternAvailablePropertyId',
    'AnnotationType_CircularReferenceError', 'NotificationKind',
    'UIA_GridItemColumnSpanPropertyId', 'UIA_MarginBottomAttributeId',
    'UIA_FormLandmarkTypeId',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'UIA_NavigationLandmarkTypeId', 'UIA_ValuePatternId',
    'UIA_AnnotationObjectsPropertyId', 'SynchronizedInputType',
    'UIA_IsKeyboardFocusablePropertyId', 'CUIAutomation8',
    'ProviderOptions_HasNativeIAccessible',
    'UIA_MenuBarControlTypeId', 'UIA_OrientationPropertyId',
    'UIA_GridColumnCountPropertyId', 'ScrollAmount', 'StyleId_Title',
    'TreeScope_Subtree', 'UIA_IsScrollPatternAvailablePropertyId',
    'AnnotationType_DataValidationError', 'HeadingLevel_None',
    'WindowInteractionState_NotResponding',
    'PropertyConditionFlags_None', 'RowOrColumnMajor_RowMajor',
    'ScrollAmount_LargeDecrement', 'IUIAutomationWindowPattern',
    'TextEditChangeType_None', 'UIA_GridItemPatternId',
    'UIA_ItemTypePropertyId', 'StyleId_Heading5',
    'UIA_AutomationFocusChangedEventId', 'UIA_TabControlTypeId',
    'AutomationElementMode', 'SynchronizedInputType_LeftMouseUp',
    'StructureChangeType_ChildRemoved',
    'UIA_RangeValueLargeChangePropertyId', 'UIA_CustomLandmarkTypeId',
    'ProviderOptions_NonClientAreaProvider',
    'IUIAutomationSelectionItemPattern', 'UIA_RotationPropertyId',
    'UIA_RangeValueSmallChangePropertyId',
    'IUIAutomationNotCondition', 'UIA_BoundingRectanglePropertyId',
    'UIA_IndentationLeadingAttributeId',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'IUIAutomationSynchronizedInputPattern',
    'UIA_ValueIsReadOnlyPropertyId', 'UIA_TextPattern2Id',
    'UIA_IsEnabledPropertyId', 'UIA_ListItemControlTypeId',
    'UIA_IsTextPatternAvailablePropertyId',
    'UIA_Window_WindowClosedEventId', 'UIA_GridItemColumnPropertyId',
    'IAccessible', 'IUIAutomationLegacyIAccessiblePattern',
    ...
    'UIA_OverlineColorAttributeId', 'AutomationElementMode_Full',
    'NotificationProcessing_All',
    'UIA_Selection2CurrentSelectedItemPropertyId',
    'UIA_ThumbControlTypeId',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'UIA_OverlineStyleAttributeId', 'IUIAutomationBoolCondition',
    'IUIAutomationStylesPattern', 'UIA_WindowIsTopmostPropertyId',
    'UIA_GroupControlTypeId', 'ZoomUnit_NoAmount',
    'UIA_BackgroundColorAttributeId',
    'UIA_AfterParagraphSpacingAttributeId', 'ZoomUnit_SmallIncrement',
    'NotificationKind_ActionAborted', 'StyleId_Custom',
    'UIA_ToggleToggleStatePropertyId', 'IUIAutomationTextRange2',
    ...
    'CUIAutomation', 'TextPatternRangeEndpoint',
    'ScrollAmount_SmallIncrement', 'IUIAutomationTreeWalker',
    'TextPatternRangeEndpoint_End', 'ScrollAmount_NoAmount',
    'UIA_ScrollVerticallyScrollablePropertyId',
    'UIA_HeaderControlTypeId', 'IUIAutomationTextChildPattern',
    'UIA_MainLandmarkTypeId', 'UIA_FillTypePropertyId'
]

_check_version('1.1.14', 1655251323.653785)
